...
namespace App\Http\Controllers\Login3;
...
class IndexController extends Controller
{
     ...
     */
    public function proload_login3(Request $request)
    {
        ...
        return view('login.login')
            ...
            ->with('loginserver_ip', env('LOGIN_SERVER_IP_LINUX'))
            ->with('loginserver_port', env('LOGIN_SERVER_PORT'))
