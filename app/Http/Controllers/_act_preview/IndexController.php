...
namespace App\Http\Controllers\_act_preview;
...
class IndexController extends Controller
{
     ...
     */
    public function proload_public_tx(Request $request)
    {
        ...
        return view('login.login')
            ->with('game_url', env('CLIENT_ROOT_ACT_PREVIEW'))
            ->with('loginserver_ip', env('LOGIN_SERVER_IP_ACT_PREVIEW'))
            ->with('loginserver_port', env('LOGIN_SERVER_PORT_ACT_PREVIEW'))
