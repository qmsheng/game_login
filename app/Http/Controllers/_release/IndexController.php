...
namespace App\Http\Controllers\_release;
...
class IndexController extends Controller
{
    ...
    public function proload_public_tx(Request $request)
    {
        ...
        return view('login.login')
            ->with('game_url', env('CLIENT_ROOT_RELEASE'))
            ->with('loginserver_ip', env('LOGIN_SERVER_IP_RELEASE'))
            ->with('loginserver_port', env('LOGIN_SERVER_PORT_RELEASE'))
