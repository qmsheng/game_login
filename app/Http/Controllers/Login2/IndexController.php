...
namespace App\Http\Controllers\Login2;
...
class IndexController extends Controller
{
     ...
     */
    public function proload_login2(Request $request)
    {
        ...
        return view('login.login')
            ->with('game_url', env('CLIENT_ROOT_URL2'))
            ->with('loginserver_ip', env('LOGIN_SERVER_IP2'))
            ->with('loginserver_port', env('LOGIN_SERVER_PORT2'))
