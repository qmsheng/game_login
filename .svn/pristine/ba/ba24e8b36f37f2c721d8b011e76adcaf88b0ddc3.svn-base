...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    <head>
		...
		<script src="http://minigame.qq.com/plat/social_hall/app_frame/qqgamelib.js"></script> 
		<script type="text/javascript" charset="utf-8" src="http://imgcache.qq.com/bossweb/ipay/js/api/cashier.js"></script>
		<script type="text/javascript" charset="utf-8" 
			src="http://fusion.qq.com/fusion_loader?appid=1105710488&platform=qqgame">
		</script>
		
        <script src="bin-debug/js_tencent.js"></script>
		...
		window.onload = function() {
            ...
            //�?��是否安装flash player,如果没安�?则提交错误log
...
<!--
    ...
    <div id="resizeTarget" style="width:1280px;height:720px;background:#000000">	
		<div id="gameContent" style="width:100%;height:100%;background:#ffffff;">
